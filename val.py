...
from models.boyuanModules import DetectMultiBackend
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='./data/boyuan.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='./weights/20230717.pt', help='model.pt path(s)')
...
# 0.978      0.977      0.987      0.787  20230721
# 0.971      0.954      0.976      0.775  20230717
