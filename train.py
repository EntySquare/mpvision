...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/architecture.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/poker.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='./data/boyuan_hyp.yaml', help='hyperparameters path')
